...
class SMANET2PlusPacket:
    ...
    def debugViewPacket(self):
        ...
        s = ""
        pl=""
        for j in range(len(self.packet)-1,pos-1,-1):
            pl += "%02x" % self.packet[j]
...
def cmdexec(msg,mylocalBTAddress,AddressFFFFFFFF,packet_send_counter,plus1,InverterCodeArray,pac1,pac2,pac3,btSocket,bluetoothbuffer,powdata):
    print msg
    ...
    pluspacket9.pushLongs(pac1,pac2,pac3)
    ...
    packet_send_counter += plus1;
    print msg


def main(bd_addr,InverterPassword):
    #This is my fake address (5caffold)
    InverterCodeArray = bytearray([0x83,0x00,0x5c,0xaf,0xf0,0x1d]);
    # Dummy arrays
    ...
    try:
            ...
            packet_send_counter += 1;
            powdata=[]
            cmdexec("\n\nSpotDCVoltage"        ,mylocalBTAddress,AddressFFFFFFFF,packet_send_counter,1,InverterCodeArray,0x53800200,0x00451F00,0x004521FF,btSocket,bluetoothbuffer,powdata);
            cmdexec("\n\nGetTypeLabel"         ,mylocalBTAddress,AddressFFFFFFFF,packet_send_counter,1,InverterCodeArray,0x53800200,0x00821E00,0x008220FF,btSocket,bluetoothbuffer,powdata);
            cmdexec("\n\nTotalYield"           ,mylocalBTAddress,AddressFFFFFFFF,packet_send_counter,1,InverterCodeArray,0x54000200,0x00260100,0x002622FF,btSocket,bluetoothbuffer,powdata);
            cmdexec("\n\nSpotACVoltage"        ,mylocalBTAddress,AddressFFFFFFFF,packet_send_counter,1,InverterCodeArray,0x51000200,0x00464000,0x004642FF,btSocket,bluetoothbuffer,powdata);
            cmdexec("\n\nSpotACVoltage2"       ,mylocalBTAddress,AddressFFFFFFFF,packet_send_counter,1,InverterCodeArray,0x51000200,0x00464800,0x004655FF,btSocket,bluetoothbuffer,powdata);
            cmdexec("\n\nSpotACInstantPower"   ,mylocalBTAddress,AddressFFFFFFFF,packet_send_counter,1,InverterCodeArray,0x51000200,0x00263F00,0x00263FFF,btSocket,bluetoothbuffer,powdata);
            cmdexec("\n\nMaxACPower"           ,mylocalBTAddress,AddressFFFFFFFF,packet_send_counter,1,InverterCodeArray,0x51000200,0x00411E00,0x004120FF,btSocket,bluetoothbuffer,powdata);
            cmdexec("\n\nMaxACPower2"          ,mylocalBTAddress,AddressFFFFFFFF,packet_send_counter,1,InverterCodeArray,0x51000200,0x00832A00,0x00832AFF,btSocket,bluetoothbuffer,powdata);
            cmdexec("\n\nChargeStatus"         ,mylocalBTAddress,AddressFFFFFFFF,packet_send_counter,1,InverterCodeArray,0x51000200,0x00295A00,0x00295AFF,btSocket,bluetoothbuffer,powdata);
            cmdexec("\n\nSpotGridFrequency"    ,mylocalBTAddress,AddressFFFFFFFF,packet_send_counter,1,InverterCodeArray,0x51000200,0x00465700,0x004657FF,btSocket,bluetoothbuffer,powdata);
            cmdexec("\n\nOperationTime"        ,mylocalBTAddress,AddressFFFFFFFF,packet_send_counter,1,InverterCodeArray,0x54000200,0x00462E00,0x00462FFF,btSocket,bluetoothbuffer,powdata);
            cmdexec("\n\nInverter Temperature" ,mylocalBTAddress,AddressFFFFFFFF,packet_send_counter,1,InverterCodeArray,0x52000200,0x00237700,0x002377FF,btSocket,bluetoothbuffer,powdata);
            cmdexec("\n\nDeviceStatus"         ,mylocalBTAddress,AddressFFFFFFFF,packet_send_counter,1,InverterCodeArray,0x51800200,0x00214800,0x002148FF,btSocket,bluetoothbuffer,powdata);
            cmdexec("\n\nGridRelayStatus"      ,mylocalBTAddress,AddressFFFFFFFF,packet_send_counter,1,InverterCodeArray,0x51800200,0x00416400,0x004164FF,btSocket,bluetoothbuffer,powdata);
            cmdexec("\n\nDailyYield"           ,mylocalBTAddress,AddressFFFFFFFF,packet_send_counter,1,InverterCodeArray,0x54000200,0x00262200,0x002622ff,btSocket,bluetoothbuffer,powdata);
            #print powdata
